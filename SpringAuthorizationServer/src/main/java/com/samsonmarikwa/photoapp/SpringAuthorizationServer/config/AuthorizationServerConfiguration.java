...
public class AuthorizationServerConfiguration {
   ...
   public RegisteredClientRepository registeredClientRepository() {
      RegisteredClient registeredClient = RegisteredClient.withId(UUID.randomUUID().toString())
            ...
            // The authorization server will redirect the client to this uri when the authorization is successful.
            // The client app should be able to handle the endpoint
            ...
            .build();
      // return new JdbcRegisteredClientRepository(registerClient);  // we can use this to persist client repository
